...
function wp_next_coda_ew_load(){
	...
	add_action('in_widget_form', 'wp_next_coda_ew_extend_form', 10, 3);

	// save our new things
	add_filter('widget_update_callback', 'wp_next_coda_ew_extend_update', 10, 4);

	// display content if needed
	add_filter('widget_display_callback', 'wp_next_coda_ew_extend_display', 10, 3);
}
 ...
 * Handlers
*/
function wp_next_coda_ew_extend_form($class, $return, $instance){
	...
	add_action('wp_next_coda_ew_extend_form', $class, $return, $instance);

	return $return;
}

function wp_next_coda_ew_extend_update($instance, $new_instance, $old_instance, $this){
	$new_instance = apply_filters('wp_next_coda_ew_extend_update', $new_instance, $old_instance, $instance, $this);

	return $new_instance;
}

function wp_next_coda_ew_extend_display($instance, $this, $args){
